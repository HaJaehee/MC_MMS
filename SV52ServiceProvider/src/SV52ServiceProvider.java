...
public class SV52ServiceProvider {
	public static void main(String args[]) throws Exception{
		String myMRN = "urn:mrn:smart:service:inst:mof:sv52";
		int port = 8952;
		...
		server.setServerPort(port, "/forwarding", new MMSClientHandler.RequestCallback() {
			...
			public String respondToClient(Map<String,List<String>> headerField, String message) {
				try {
					...
					//it only forwards messages to sc having urn:mrn:smart:vessel:imo-no:mof:5000052
					sender.sendPostMsg("urn:mrn:smart:vessel:imo-no:mof:5000052", message);
				} catch (Exception e) {
					e.printStackTrace();
				}
				return "OK";
