...
while true; do
    ...
    case $yn in
        [Yy]* )  
		sudo docker stop $(sudo docker ps | grep -E "mcp_mms_monitoring|mcp_mms_monitoring_mariadb|mariadb|mcp_mms_monitoring_rabbitmq" | cut -c1-12)
		sudo docker rm $(sudo docker ps --all | grep -E "mcp_mms_monitoring|mcp_mms_monitoring_mariadb|mariadb|mcp_mms_monitoring_rabbitmq" | cut -c1-12)
