...
directory and a user does not pass options to MMS Server when user runs MMS Server.<br/>
...
<b>MMS configuration options</b> is loaded if a user passes options to MMS Server when the user runs MMS Server.<br/>
