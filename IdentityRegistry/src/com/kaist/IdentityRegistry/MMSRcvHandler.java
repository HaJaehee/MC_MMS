...
public class MMSRcvHandler {
    ...
    static class MyHandler implements HttpHandler {
    	com.kaist.IdentityRegistry.MMSClientHandler.reqCallBack myreqCallBack;
    	public void setReqCallBack(com.kaist.IdentityRegistry.MMSClientHandler.reqCallBack callback){
